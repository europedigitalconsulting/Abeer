  ...
  var toggleLayout = function() {
    ...
    if(w.outerWidth() <= 1024) {
      ...
      if(now_layout_class == 'layout-3') {
        ...
        main_sidebar.find('.container').addClass('sidebar-wrapper').removeClass('container-fluid');
        ...
        sidebar_dropdown();
          $(".main-wrapper").removeClass("container-fluid");
      }
    }else{
      ...
      if(now_layout_class == 'layout-3' && nav_second.hasClass('main-sidebar')) {
        ...
        let main_sidebar = $(".navbar-secondary");
          main_sidebar.find('.sidebar-wrapper').addClass('container-fluid').removeClass('sidebar-wrapper');
